...
func (t *Tree) extract(q *d, i int) { // (r string) {
	t.ver++
...
func (t *Tree) First() (k uint64, v string) {
	if q := t.first; q != nil {
		q := &q.d[0]
		k, v = q.k, q.v
	}
...
func (t *Tree) Get(k uint64) (v string, ok bool) {
	q := t.r
	if q == nil {
		return
	}
...
func (t *Tree) insert(q *d, i int, k uint64, v string) *d {
	t.ver++
	c := q.c
	if i < c {
...
// (zero-value, zero-value) if the tree is empty.
func (t *Tree) Last() (k uint64, v string) {
	if q := t.last; q != nil {
		q := &q.d[q.c-1]
		k, v = q.k, q.v
	}
...
func (t *Tree) overflow(p *x, q *d, pi, i int, k uint64, v string) {
	t.ver++
	l, r := p.siblings(pi)
...
func (t *Tree) Set(k uint64, v string) {
	//dbg("--- PRE Set(%v, %v)\n%s", k, v, t.dump())
	//defer func() {
	//	dbg("--- POST\n%s\n====\n", t.dump())
	//}()
...
func (t *Tree) Put(k uint64, upd func(oldV string, exists bool) (newV string, write bool)) (oldV string, written bool) {
	pi := -1
	var p *x
	q := t.r
	var newV string
...
func (t *Tree) split(p *x, q *d, pi, i int, k uint64, v string) {
	t.ver++
	r := btDPool.Get().(*d)
	if q.n != nil {
		r.n = q.n
...
// io.EOF is returned.
func (e *Enumerator) Next() (k uint64, v string, err error) {
...
// == io.EOF is returned.
func (e *Enumerator) Prev() (k uint64, v string, err error) {
	if err = e.err; err != nil {
		return
	}
